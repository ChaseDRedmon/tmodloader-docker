...
Terraria server 1.4.2.3 with tModLoader v0.11.8.4.

You must run the dockerfile as the docker image this repo links to is out of date! (Terraria version 1.3.5.3 w/TModLoader v0.11.7.8)
...
[Terraria Version]: https://img.shields.io/badge/Terraria-1.4.2.3-blue
